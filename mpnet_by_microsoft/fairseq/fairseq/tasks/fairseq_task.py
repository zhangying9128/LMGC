...
class FairseqTask(object):
    ...
    def inference_step(self, generator, models, sample, evel_input_mode='mpnet', prefix_tokens=None):
        with torch.no_grad():
            return generator.generate(models, sample, evel_input_mode=evel_input_mode, prefix_tokens=prefix_tokens)
