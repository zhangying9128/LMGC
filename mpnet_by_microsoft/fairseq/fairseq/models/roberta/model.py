...
class RobertaModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--use-relative-positions', action='store_true',
                            help='Use relation positions embedding, borrow ideas from T5.')
        parser.add_argument('--normalize-before', action='store_true',
                            help='apply layernorm before each layer')
    ...
    def register_question_answer_head(self, name, num_classes=None):
        self.classification_heads[name] = RobertaQAHead(
            self.args.encoder_embed_dim,
            num_classes,
        )
    ...
    def upgrade_state_dict_named(self, state_dict, name):
        ...
        for k in state_dict.keys():
            ...
            if k.startswith('classification_heads.question_answer_head'):
                continue
...
class RobertaEncoder(FairseqDecoder):
    ...
    def __init__(self, args, dictionary):
        ...
        self.sentence_encoder = TransformerSentenceEncoder(
            ...
            has_relative_attention_bias=args.use_relative_positions,
